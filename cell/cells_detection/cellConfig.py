...
class CellConfig(Config):
    ...
    IMAGES_PER_GPU = 6  # basically it was six
    ...
    STEPS_PER_EPOCH = len(os.listdir(os.path.join(
        DATASET_DIR, "train"))) // IMAGES_PER_GPU

    # VALIDATION_STEPS = max(1, len(VAL_IMAGE_IDS) // IMAGES_PER_GPU)
    VALIDATION_STEPS = max(
        1, len(os.listdir(os.path.join(DATASET_DIR, "val"))) // IMAGES_PER_GPU)
    ...
    RPN_TRAIN_ANCHORS_PER_IMAGE = 64   # 128
