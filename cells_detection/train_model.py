...
def selectWeights(model, weights=""):
...
def prepareDatasets(dataset_dir, config):
    ...
    return dataset_train, dataset_val, augmentation


def train(model, config, dataset_train, dataset_val, augmentation):
    """Train the model."""
