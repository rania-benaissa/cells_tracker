...
video_name = 'VOT-Ball'
TEST_SAVE_DIR = 'saved_images_meanshift'
...
mask = cv2.inRange(hsv_roi, np.array((0., 30., 20.)),
...
while(1):
    ...
    if ret == True:
        ...
        if k == 27:
            ...
            cv2.imwrite(submit_dir + '/backprojection_%04d.png' % cpt, dst)
            cv2.imwrite(submit_dir + '/hue_channel_%04d.png' % cpt, hue_image)
        cpt += 1
    else:
        break
